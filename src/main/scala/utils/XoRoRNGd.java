...
/*  Based on code written in 2016 by David Blackman and Sebastiano Vigna (vigna@acm.org)
http://squidpony.github.io/SquidLib/squidlib-util/apidocs/src-html/squidpony/squidmath/XoRoRNG.html
*/
 ...
 * @author Matthias Nickles (cosmetic changes)
 */
public /*final*/ class XoRoRNGd extends java.util.Random {
     ...
     */
    public XoRoRNGd(final long seed) {
        setSeed(seed);
    }
    /**
     ...
     */
    public XoRoRNGd(final long stateA, final long stateB) {
    ...
    public XoRoRNGd copy() {
        XoRoRNGd next = new XoRoRNGd(state0);
        next.state0 = state0;
        next.state1 = state1;
        return next;
    }
